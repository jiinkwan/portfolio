CREATE TABLE XX_MENU_EXCLU_LOAD AS
select
       (SELECT res1.RESPONSIBILITY_ID FROM apps.fnd_responsibility_vl res1 WHERE res1.RESPONSIBILITY_NAME = 'UAL ' || res.responsibility_name) responsibility_id
     , 'UAL ' || res.responsibility_name responsibility_name
